...
*/
const animalNames = zooAnimals.forEach(arr => {
  arr.animal_name + arr.scientific_name
...
for( let i = 0; i < zooAnimals.length; i++){
  if (zooAnimals[i].population < 5){
    largerPopulation.push(zooAnimals[i].population)
  }
}
...
*/
const populationTotal = zooAnimals.reduce((populationTot, animals) => populationTot + animals.population, 0);
